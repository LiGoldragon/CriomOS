{
  ...
  inputs = {
    ...
    criomos-home.url = "github:LiGoldragon/CriomOS-home/ac54e3af28d7ca3d01c58395594148040f2718a5";
    ...
    lojix.url = "github:LiGoldragon/lojix/33b8b6b7e5f893278a27c77130e8542072addda0";
