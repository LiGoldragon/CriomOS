{
  ...
  inputs = {
    ...
    criomos-home.url = "github:LiGoldragon/CriomOS-home/44c2995c9d551a3e3b028dff9d347863d792c40c";
    ...
    lojix.url = "github:LiGoldragon/lojix/d0f7e83e8dc17a21b96232870e71ea6a5051da34";
