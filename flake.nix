{
  ...
  inputs = {
    ...
    orchestrate.url = "github:LiGoldragon/orchestrate/885f6e3e67ac8c157825dbb11f3d05c7a148b56e";
    orchestrate.inputs.nixpkgs.follows = "nixpkgs";

    # Home profile — its own repo, own inputs (niri, noctalia, stylix, emacs…).
    criomos-home.url = "github:LiGoldragon/CriomOS-home/26999bd90cc65add5f7331d9a89a9c1d3028bace";
    ...
    lojix.url = "github:LiGoldragon/lojix/34a8e9c2e6af3d6dbc2b8ad83c43758f5fdb16ca";
