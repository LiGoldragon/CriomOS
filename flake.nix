{
  ...
  inputs = {
    ...
    criomos-home.url = "github:LiGoldragon/CriomOS-home/5f8ff102ca1f3a12947a45cae801e47c504dfe9d";
    ...
    lojix.url = "github:LiGoldragon/lojix/63048a4e6c0df91aebfaf9f31758ba8e4e25381b";
