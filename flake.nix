{
  ...
  inputs = {
    ...
    criomos-home.url = "github:LiGoldragon/CriomOS-home/0548644f797ca873cada2309a64c46aad4e318a0";
    ...
    lojix.url = "github:LiGoldragon/lojix/8bb4b0a1c7816f72b97dc53f3a5a1da2765c95b0";
