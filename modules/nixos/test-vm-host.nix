...
let
  ...
  maximumGuests = if vmHost == null then null else (vmHost.maximumGuests or vmHost.maximum_guests or null);
  ...
  subnetBase = if vmHost == null then null else stripCidr (vmHost.guestSubnet or vmHost.guest_subnet or null);
